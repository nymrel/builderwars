...
const CACHE_NAME = "builderwars-mobile-arena-v41";
const NAVIGATION_FALLBACK = "./index.html?v=41";
const LOCAL_ASSETS = [
  NAVIGATION_FALLBACK,
  "./styles.css?v=41",
  "./data-adapter.js?v=41",
  "./app.js?v=41",
  "./ten-fronts.html?v=41",
  "./ten-fronts-blitz.css?v=41",
  "./ten-fronts-blitz.js?v=41",
