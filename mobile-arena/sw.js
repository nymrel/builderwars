...
const CACHE_NAME = "builderwars-mobile-arena-v39";
const NAVIGATION_FALLBACK = "./index.html?v=39";
const LOCAL_ASSETS = [
  NAVIGATION_FALLBACK,
  "./styles.css?v=39",
  "./data-adapter.js?v=39",
  "./app.js?v=39",
  "./ten-fronts.html?v=39",
  "./ten-fronts-blitz.css?v=39",
  "./ten-fronts-blitz.js?v=39",
