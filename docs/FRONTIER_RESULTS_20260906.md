...
of √(2·ln20/128) ≈ 0.34, so a real gain needed to be enormous to clear +0.05. At 512
pairs the penalty is ≈ 0.17. Both effects compound: longer training raises the true
