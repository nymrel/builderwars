...
| 7 | Mobile static contracts | Checks deterministic mobile, truth, offline, accessibility, and exact game/version/format/engine/resource-scoped proof-rating contracts; rows remain alphabetic and ranking-ineligible | Hosted route, real user, deployed device support, cross-scope comparison, global ranking |
