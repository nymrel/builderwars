...
COMPONENTS = (
    ...
    _component("C-004", "Hosted state store", "transactional tenant, browser-idempotency, runner, nonce, lease, result, and projection state", "sqlite_reference_only", ("EA-003", "EA-004", "EA-006", "EA-019")),
...
THREATS = (
    ...
    _threat(
        ...
        ("EA-004", "EA-014", "EA-016", "EA-019"),
        ("production_regions_subprocessors_processing_obligations_retention_periods_backup_restore_and_deletion_propagation_unproven",),
        ("Promote the source-bound reference data map into an approved production inventory with accountable owners, regions, subprocessors, purposes, and exact retention periods.", "Implement idempotent tenant-scoped deletion with retry dead-letter and redacted receipts.", "Run supervised restore and rollback against an external backup."),
