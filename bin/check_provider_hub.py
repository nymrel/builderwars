...
_PY_COMPILE_TARGETS = [
    ...
    "publishing/commissioner.py",
    "publishing/league_operations.py",
    "publishing/measurement.py",
    "publishing/observability.py",
    "publishing/capacity_readiness.py",
    "publishing/corrections.py",
    "publishing/scoped_ratings.py",
    "publishing/reference_data_map.py",
    "publishing/retention_recovery.py",
    "publishing/support_readiness.py",
    ...
    "publishing/source_decision.py",
    "creator_sdk/__init__.py",
    "creator_sdk/runtime.py",
    ...
    "bin/apply_publication_candidate.py",
    "bin/check_publication_source_decision.py",
    "bin/creator_game.py",
    "bin/check_creator_game_sdk.py",
    "bin/build_mobile_creator_game_lab.py",
    "bin/check_mobile_arena_creator_game.py",
    "bin/build_agentwars_runner_bundle.py",
    "bin/check_agentwars_dependency_lock.py",
    "bin/check_agentwars_product.py",
    "bin/check_agentwars_runner_bundle.py",
    "bin/check_agentwars_starter_kit.py",
    "bin/check_mobile_arena_contrast.py",
    "bin/check_mobile_arena_exchange.py",
    "bin/check_agentwars_corrections.py",
    "bin/check_agentwars_scoped_ratings.py",
    "bin/agentwars_commissioner.py",
    "bin/check_agentwars_commissioner.py",
    "bin/check_agentwars_league_operations.py",
    "bin/check_agentwars_measurement.py",
    "bin/check_agentwars_observability.py",
    "bin/agentwars_support.py",
    "bin/check_agentwars_support.py",
    "bin/check_agentwars_retention_recovery.py",
    "bin/builderwars_capacity.py",
    "bin/check_builderwars_capacity.py",
    "bin/check_builderwars_data_map.py",
    "bin/check_builderwars_threat_model.py",
    "bin/check_agentwars_tester_readiness.py",
    "bin/check_agentwars_discoverability.py",
    "bin/check_agentwars_local_launch_evidence.py",
    "bin/check_mobile_arena_performance_budget.py",
    "bin/check_mobile_arena_ten_fronts_blitz.py",
    "bin/check_runback_lineage.py",
    "bin/check_runback_surface_admission.py",
    "bin/check_share_bundle.py",
    "bin/verify_agentwars_runner_bundle.py",
...
_LADDER = [
    ...
    [sys.executable, "-B", "bin/check_publication_source_decision.py"],
    [sys.executable, "-B", "bin/check_agentwars_dependency_lock.py"],
    [sys.executable, "-B", "bin/check_agentwars_runner_bundle.py"],
    [sys.executable, "-B", "bin/check_agentwars_starter_kit.py"],
    [sys.executable, "-B", "bin/check_creator_game_sdk.py"],
    [sys.executable, "-B", "bin/check_mobile_arena_creator_game.py"],
    [sys.executable, "bin/check_agentwars_scale.py"],
    [sys.executable, "-B", "bin/check_agentwars_corrections.py"],
    [sys.executable, "-B", "bin/check_agentwars_scoped_ratings.py"],
    [sys.executable, "-B", "bin/check_mobile_arena_contrast.py"],
    [sys.executable, "bin/check_mobile_arena_exchange.py"],
    [sys.executable, "-B", "bin/check_agentwars_discoverability.py"],
    [sys.executable, "-B", "bin/check_runback_lineage.py"],
    [sys.executable, "-B", "bin/check_runback_surface_admission.py"],
    [sys.executable, "bin/check_share_bundle.py"],
    [sys.executable, "-B", "bin/check_agentwars_league_operations.py"],
    [sys.executable, "-B", "bin/check_agentwars_commissioner.py"],
    [sys.executable, "bin/check_agentwars_measurement.py"],
    [sys.executable, "bin/check_mobile_arena_performance_budget.py"],
    [sys.executable, "-B", "bin/check_mobile_arena_ten_fronts_blitz.py"],
    [sys.executable, "bin/check_agentwars_observability.py"],
    [sys.executable, "-B", "bin/check_agentwars_support.py"],
    [sys.executable, "bin/check_agentwars_retention_recovery.py"],
    [sys.executable, "-B", "bin/check_builderwars_capacity.py"],
    [sys.executable, "-B", "bin/check_builderwars_data_map.py"],
