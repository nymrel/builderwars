...
STAGES: tuple[StageDefinition, ...] = (
    ...
    StageDefinition(
        ...
        "Hosted-control-plane security, refusal, rollback, cleanup, capacity-correctness, and repository-grounded threat-model tests",
        "local_executable",
        commands=(
    ...
    StageDefinition(
        ...
        evidence_files=(
            ...
            "docs/AGENTWARS_SUPPORT_RUNBOOK.md",
