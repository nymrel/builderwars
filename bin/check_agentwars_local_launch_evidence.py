...
def main() -> int:
    ...
    check(
        ...
        "stage 3 runs product, fantasy, finite-league operations, starter, and scale gates",
    )
    check(
        ...
        "stage 3 binds the finite fantasy league operations and starter contracts",
    )
    ...
    check(
        ...
        "stage 10 runs the exact measurement, performance, observability, retention/recovery, tester-readiness, and discoverability gates",
    )
    ...
    check(len(commands) == 21, "local evidence contract has exactly 21 bounded commands")
