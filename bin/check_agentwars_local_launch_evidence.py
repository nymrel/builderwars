...
def main() -> int:
    ...
    check(
        ...
        "stage 10 runs the exact measurement, performance, observability, and retention/recovery gates",
    )
    ...
    check(len(commands) == 15, "local evidence contract has exactly 15 bounded commands")
