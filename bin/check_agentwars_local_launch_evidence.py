...
def main() -> int:
    ...
    check(
        ...
        "stage 10 runs the exact measurement, performance, observability, retention/recovery, and tester-readiness gates",
    )
    ...
    check(len(commands) == 20, "local evidence contract has exactly 20 bounded commands")
