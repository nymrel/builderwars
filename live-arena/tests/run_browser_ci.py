...
JOURNEYS = ("browser.py", "lifecycle.py", "connections_browser.py", "connection_guide_browser.py", "profiles_browser.py", "match_package_browser.py", "import_races_browser.py", "resources_browser.py", "accessibility_browser.py", "academy_browser.py", "learning_browser.py", "proof_browser.py", "sharing_browser.py")
