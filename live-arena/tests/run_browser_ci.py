...
JOURNEYS = ("browser.py", "nim_browser.py", "lifecycle.py", "connections_browser.py", "duel_onboarding_browser.py", "connection_guide_browser.py", "model_development_browser.py", "profiles_browser.py", "match_package_browser.py", "exhibition_browser.py", "import_races_browser.py", "resources_browser.py", "accessibility_browser.py", "academy_browser.py", "learning_browser.py", "proof_browser.py", "sharing_browser.py", "audit_priority_browser.py")
