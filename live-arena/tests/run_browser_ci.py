...
JOURNEYS = ("browser.py", "lifecycle.py", "connections_browser.py", "profiles_browser.py", "match_package_browser.py", "resources_browser.py", "accessibility_browser.py", "academy_browser.py", "proof_browser.py", "sharing_browser.py")
